...
20. Homepage repeatable impact checks:
...
21. Homepage strategic pillars CMS checks:
...
22. Homepage flexible custom section checks:
...
23. Homepage drag-and-drop order checks:
